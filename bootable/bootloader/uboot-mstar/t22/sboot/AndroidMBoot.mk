...
export BOARD_UFBL_PROJECT BOARD_KERNEL_SEPARATED_DT TARGET_PREBUILT_DTB
...
$(TARGET_BUILT_MBOOT): $(TARGET_MBOOT_CONFIG)
	@echo "Building mboot from $(MBOOT_DIR)"
	$(MAKE_SBOOT) UFBL_PROJECT=sophia  -C $(MBOOT_DIR) PRODUCT_OUT=$(abspath $(PRODUCT_OUT)) O=$(MBOOT_OUT)

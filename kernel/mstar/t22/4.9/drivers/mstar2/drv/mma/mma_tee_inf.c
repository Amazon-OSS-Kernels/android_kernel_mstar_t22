...
{
    if(1 == optee_version){
        return mma_tee_invoke_1x(session, commandID, operation, return_origin);
    }else if(2 == optee_version){
        return mma_tee_invoke_2x(session, commandID, operation, return_origin);
    }else{

...
#ifdef GPU_MAX_CLOCK
int mali_gpu_clock = GPU_MAX_CLOCK;
...
int enable_null_mali = 0;
module_param(enable_null_mali, int, S_IRUSR | S_IWUSR | S_IWGRP | S_IRGRP | S_IROTH); /* rw-rw-r-- */
MODULE_PARM_DESC(enable_null_mali, "Skip GP and PP jobs in device driver");
#endif
#endif

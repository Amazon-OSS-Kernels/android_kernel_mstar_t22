...
#elif (NUM_PP == 3)
#if defined(MSTAR_ENABLE_PMU)
    MALI_GPU_RESOURCES_MALI450_MP3_PMU(0, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ)
#else
...
#endif
#elif defined(MALI470)
#if (NUM_PP == 1)
    MALI_GPU_RESOURCES_MALI470_MP1(0, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ)
#elif (NUM_PP == 2)
    MALI_GPU_RESOURCES_MALI470_MP2(0, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ)
#elif (NUM_PP == 3)
    MALI_GPU_RESOURCES_MALI470_MP3(0, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ)
#elif (NUM_PP == 4)
    MALI_GPU_RESOURCES_MALI470_MP4(0, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ, MALI_IRQ)
#else
#error "invalid NUM_PP for MALI-470"
#endif
#else
#error "unknown GPU"
#endif
...
#if defined(MSTAR_TIMEOUT_PATCH)
    .max_job_runtime = 500,   /* timeout: 0.5 seconds */
#else
    .max_job_runtime = 5000,   /* timeout: 5 seconds */
#endif
...
#elif defined(MALI470)
    MALI_DEBUG_PRINT(4, ("Registering Mali-470 MP%d device\n", NUM_PP));
#else
    #error "unknown GPU"
#endif

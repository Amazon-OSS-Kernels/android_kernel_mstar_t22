...
#ifdef MSTAR_DVFS_BOOST
	under_perform_boundary_value = MALI_PERCENTAGE_TO_UTILIZATION_FRACTION(3);
	over_perform_boundary_value = MALI_PERCENTAGE_TO_UTILIZATION_FRACTION(1);
#else

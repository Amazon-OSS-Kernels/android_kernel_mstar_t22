...
extern int mstar_platform_get_efuse_core_num(void);
#endif
/* MSTAR patch end */
...
/* MSTAR patch begin */
#if defined(MSTAR_DISABLE_GPU_CORES)
	efuse_pp_core_num = mstar_platform_get_efuse_core_num();
	MALI_DEBUG_PRINT(2, ("efuse_pp_core_num=%d\n", efuse_pp_core_num));
	for  (n = 7; n >= efuse_pp_core_num; n--)
	{
		resource_pp_found[n] = _MALI_OSK_ERR_ITEM_NOT_FOUND;
		resource_pp_mmu_found[n] = _MALI_OSK_ERR_ITEM_NOT_FOUND;
	}
#endif
/* MSTAR patch end */

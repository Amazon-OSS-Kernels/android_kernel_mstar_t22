...
#define DirectFBKeySymbolNames(Identifier) struct DFBKeySymbolName Identifier[] = { \
     ...
     { DIKS_TILDE, "TILDE" }, \
     { DIKS_DELETE, "DELETE" }, \
     { DIKS_SUPPERSCRIPT_ONE, "SUPPERSCRIPT_ONE" }, \
     { DIKS_SUPPERSCRIPT_TWO, "SUPPERSCRIPT_TWO" }, \
     { DIKS_SUPPERSCRIPT_THREE, "SUPPERSCRIPT_THREE" }, \
     { DIKS_ACUTE_ACCENT, "ACUTE_ACCENT" }, \
     { DIKS_FULLWIDTH_GRAVE_ACCENT, "FULLWIDTH_GRAVE_ACCENT" }, \
     { DIKS_FULLWIDTH_TILDE, "FULLWIDTH_TILDE" }, \
     { DIKS_POUND_SIGN, "POUND_SIGN" }, \
     { DIKS_CENT_SIGN, "CENT_SIGN" }, \
     { DIKS_NOT_SIGN, "NOT_SIGN" }, \
     { DIKS_DIAERESIS_SIGN, "DIAERESIS_SIGN" }, \
     { DIKS_SECTION_SIGN, "SECTION_SIGN" }, \
     { DIKS_SOLIDUS_SIGN, "SOLIDUS_SIGN" }, \
     { DIKS_REVERSE_SOLIDUS_SIGN, "REVERSE_SOLIDUS_SIGN" }, \
     { DIKS_EURO_SIGN, "EURO_SIGN" }, \
     { DIKS_RUPEE_SIGN, "RUPEE_SIGN" }, \
     { DIKS_CRUZEIRO_SIGN, "CRUZEIRO_SIGN" }, \
     { DIKS_CAPITAL_C_WITH_CEDILLA, "CAPITAL_C_WITH_CEDILLA" }, \
     { DIKS_SMALL_C_WITH_CEDILLA, "SMALL_C_WITH_CEDILLA" }, \
     { DIKS_CAPITAL_A_WITH_GRAVE, "CAPITAL_A_WITH_GRAVE" }, \
     { DIKS_SMALL_A_WITH_GRAVE, "SMALL_A_WITH_GRAVE" }, \
     { DIKS_SMALL_E_WITH_GRAVE, "SMALL_E_WITH_GRAVE" }, \
     { DIKS_CAPITAL_E_WITH_GRAVE, "CAPITAL_E_WITH_GRAVE" }, \
     { DIKS_SMALL_I_WITH_GRAVE, "SMALL_I_WITH_GRAVE" }, \
     { DIKS_CAPITAL_I_WITH_GRAVE, "CAPITAL_I_WITH_GRAVE" }, \
     { DIKS_SMALL_O_WITH_GRAVE, "SMALL_O_WITH_GRAVE" }, \
     { DIKS_CAPITAL_O_WITH_GRAVE, "CAPITAL_O_WITH_GRAVE" }, \
     { DIKS_SMALL_U_WITH_GRAVE, "SMALL_U_WITH_GRAVE" }, \
     { DIKS_CAPITAL_U_WITH_GRAVE, "CAPITAL_U_WITH_GRAVE" }, \
     { DIKS_CAPITAL_A_WITH_ACUTE, "CAPITAL_A_WITH_ACUTE" }, \
     { DIKS_SMALL_A_WITH_ACUTE, "SMALL_A_WITH_ACUTE" }, \
     { DIKS_CAPITAL_A_WITH_CIRCUMFLEX, "CAPITAL_A_WITH_CIRCUMFLEX" }, \
     { DIKS_SMALL_A_WITH_CIRCUMFLEX, "SMALL_A_WITH_CIRCUMFLEX" }, \
     { DIKS_CAPITAL_A_WITH_TILDE, "CAPITAL_A_WITH_TILDE" }, \
     { DIKS_SMALL_A_WITH_TILDE, "SMALL_A_WITH_TILDE" }, \
     { DIKS_CAPITAL_N_WITH_TILDE, "CAPITAL_N_WITH_TILDE" }, \
     { DIKS_SMALL_N_WITH_TILDE, "SMALL_N_WITH_TILDE" }, \
     { DIKS_CAPITAL_E_WITH_ACUTE, "CAPITAL_E_WITH_ACUTE" }, \
     { DIKS_SMALL_E_WITH_ACUTE, "SMALL_E_WITH_ACUTE" }, \
     { DIKS_CAPITAL_E_WITH_CIRCUMFLEX, "CAPITAL_E_WITH_CIRCUMFLEX" }, \
     { DIKS_SMALL_E_WITH_CIRCUMFLEX, "SMALL_E_WITH_CIRCUMFLEX" }, \
     { DIKS_CAPITAL_I_WITH_CIRCUMFLEX, "CAPITAL_I_WITH_CIRCUMFLEX" }, \
     { DIKS_SMALL_I_WITH_CIRCUMFLEX, "SMALL_I_WITH_CIRCUMFLEX" }, \
     { DIKS_CAPITAL_I_WITH_ACUTE, "CAPITAL_I_WITH_ACUTE" }, \
     { DIKS_SMALL_I_WITH_ACUTE, "SMALL_I_WITH_ACUTE" }, \
     { DIKS_CAPITAL_O_WITH_ACUTE, "CAPITAL_O_WITH_ACUTE" }, \
     { DIKS_SMALL_O_WITH_ACUTE, "SMALL_O_WITH_ACUTE" }, \
     { DIKS_CAPITAL_O_WITH_CIRCUMFLEX, "CAPITAL_O_WITH_CIRCUMFLEX" }, \
     { DIKS_SMALL_O_WITH_CIRCUMFLEX, "SMALL_O_WITH_CIRCUMFLEX" }, \
     { DIKS_CAPITAL_U_WITH_CIRCUMFLEX, "CAPITAL_U_WITH_CIRCUMFLEX" }, \
     { DIKS_SMALL_U_WITH_CIRCUMFLEX, "SMALL_U_WITH_CIRCUMFLEX" }, \
     { DIKS_CAPITAL_O_WITH_TILDE, "CAPITAL_O_WITH_TILDE" }, \
     { DIKS_SMALL_O_WITH_TILDE, "SMALL_O_WITH_TILDE" }, \
     { DIKS_CAPITAL_U_WITH_ACUTE, "CAPITAL_U_WITH_ACUTE" }, \
     { DIKS_SMALL_U_WITH_ACUTE, "SMALL_U_WITH_ACUTE" }, \
     { DIKS_CAPITAL_U_WITH_DIAERESIS, "CAPITAL_U_WITH_DIAERESIS" }, \
     { DIKS_SMALL_U_WITH_DIAERESIS, "SMALL_U_WITH_DIAERESIS" }, \
     { DIKS_SMALL_A_WITH_DIAERESIS, "SMALL_A_WITH_DIAERESIS" }, \
     { DIKS_CAPITAL_A_WITH_DIAERESIS, "CAPITAL_A_WITH_DIAERESIS" }, \
     { DIKS_SMALL_E_WITH_DIAERESIS, "SMALL_E_WITH_DIAERESIS" }, \
     { DIKS_CAPITAL_E_WITH_DIAERESIS, "CAPITAL_E_WITH_DIAERESIS" }, \
     { DIKS_SMALL_I_WITH_DIAERESIS, "SMALL_I_WITH_DIAERESIS" }, \
     { DIKS_CAPITAL_I_WITH_DIAERESIS, "CAPITAL_I_WITH_DIAERESIS" }, \
     { DIKS_SMALL_O_WITH_DIAERESIS, "SMALL_O_WITH_DIAERESIS" }, \
     { DIKS_CAPITAL_O_WITH_DIAERESIS, "CAPITAL_O_WITH_DIAERESIS" }, \
     { DIKS_SMALL_Y_WITH_DIAERESIS, "SMALL_Y_WITH_DIAERESIS" }, \
     { DIKS_SMALL_Y_WITH_ACUTE, "SMALL_Y_WITH_ACUTE" }, \
     { DIKS_SMALL_A_WITH_DEGREE, "SMALL_A_WITH_DEGREE" }, \
     { DIKS_CAPITAL_A_WITH_DEGREE, "CAPITAL_A_WITH_DEGREE" }, \
     { DIKS_SMALL_E_WITH_DEGREE, "SMALL_E_WITH_DEGREE" }, \
     { DIKS_CAPITAL_E_WITH_DEGREE, "CAPITAL_E_WITH_DEGREE" }, \
     { DIKS_SMALL_G_WITH_DEGREE, "SMALL_G_WITH_DEGREE" }, \
     { DIKS_SMALL_U_WITH_DEGREE, "SMALL_U_WITH_DEGREE" }, \
     { DIKS_CAPITAL_U_WITH_DEGREE, "CAPITAL_U_WITH_DEGREE" }, \
     { DIKS_SMALL_Z_WITH_DEGREE, "SMALL_Z_WITH_DEGREE" }, \
     { DIKS_CAPITAL_Z_WITH_DEGREE, "CAPITAL_Z_WITH_DEGREE" }, \
     { DIKS_SMALL_OMEGA, "SMALL_OMEGA" }, \
     { DIKS_SMALL_ALPHA, "SMALL_ALPHA" }, \
     { DIKS_SMALL_ETA, "SMALL_ETA" }, \
     { DIKS_SMALL_EPSILON, "SMALL_EPSILON" }, \
     { DIKS_SMALL_IOTA, "SMALL_IOTA" }, \
     { DIKS_SMALL_UPSILON, "SMALL_UPSILON" }, \
     { DIKS_SMALL_OMICRON, "SMALL_OMICRON" }, \
     { DIKS_CAPITAL_OMEGA, "CAPITAL_OMEGA" }, \
     { DIKS_CAPITAL_ALPHA, "CAPITAL_ALPHA" }, \
     { DIKS_CAPITAL_ETA, "CAPITAL_ETA" }, \
     { DIKS_CAPITAL_EPSILON, "CAPITAL_EPSILON" }, \
     { DIKS_CAPITAL_IOTA, "CAPITAL_IOTA" }, \
     { DIKS_CAPITAL_UPSILON, "CAPITAL_UPSILON" }, \
     { DIKS_CAPITAL_OMICRON, "CAPITAL_OMICRON" }, \
     { DIKS_SMALL_IOTA_WITH_DIALYTIKA, "SMALL_IOTA_WITH_DIALYTIKA" }, \
     { DIKS_SMALL_UPSILON_DIALYTIKA, "SMALL_UPSILON_DIALYTIKA" }, \
     { DIKS_SMALL_IOTA_DIAERESIS, "SMALL_IOTA_DIAERESIS" }, \
     { DIKS_SMALL_UPSILON_DIAERESIS, "SMALL_UPSILON_DIAERESIS" }, \
     { DIKS_CAPITAL_IOTA_DIAERESIS, "CAPITAL_IOTA_DIAERESIS" }, \
     { DIKS_CAPITAL_UPSILON_DIAERESIS, "CAPITAL_UPSILON_DIAERESIS" }, \
     { DIKS_SMALL_OMEGA_WITH_TONOS, "SMALL_OMEGA_WITH_TONOS" }, \
     { DIKS_SMALL_ALPHA_WITH_TONOS, "SMALL_ALPHA_WITH_TONOS" }, \
     { DIKS_SMALL_ETA_WITH_TONOS, "SMALL_ETA_WITH_TONOS" }, \
     { DIKS_SMALL_EPSILON_WITH_TONOS, "SMALL_EPSILON_WITH_TONOS" }, \
     { DIKS_SMALL_IOTA_WITH_TONOS, "SMALL_IOTA_WITH_TONOS" }, \
     { DIKS_SMALL_UPSILON_WITH_TONOS, "SMALL_UPSILON_WITH_TONOS" }, \
     { DIKS_SMALL_OMICRON_WITH_TONOS, "SMALL_OMICRON_WITH_TONOS" }, \
     { DIKS_CAPITAL_OMEGA_WITH_TONOS, "CAPITAL_OMEGA_WITH_TONOS" }, \
     { DIKS_CAPITAL_ALPHA_WITH_TONOS, "CAPITAL_ALPHA_WITH_TONOS" }, \
     { DIKS_CAPITAL_ETA_WITH_TONOS, "CAPITAL_ETA_WITH_TONOS" }, \
     { DIKS_CAPITAL_EPSILON_WITH_TONOS, "CAPITAL_EPSILON_WITH_TONOS" }, \
     { DIKS_CAPITAL_IOTA_WITH_TONOS, "CAPITAL_IOTA_WITH_TONOS" }, \
     { DIKS_CAPITAL_UPSILON_WITH_TONOS, "CAPITAL_UPSILON_WITH_TONOS" }, \
     { DIKS_CAPITAL_OMICRON_WITH_TONOS, "CAPITAL_OMICRON_WITH_TONOS" }, \
     { DIKS_GREEK_TONOS, "GREEK_TONOS" }, \
     { DIKS_GREEK_DIALYTIKA, "GREEK_DIALYTIKA" }, \
     { DIKS_CEDILLA, "CEDILLA" }, \
     { DIKS_SMALL_W_WITH_ACUTE, "SMALL_W_WITH_ACUTE" }, \
     { DIKS_CAPITAL_W_WITH_ACUTE, "CAPITAL_W_WITH_ACUTE" }, \
     { DIKS_CAPITAL_Y_WITH_ACUTE, "CAPITAL_Y_WITH_ACUTE" }, \
     { DIKS_SMALL_W_WITH_GRAVE, "SMALL_W_WITH_GRAVE" }, \
     { DIKS_SMALL_Y_WITH_GRAVE, "SMALL_Y_WITH_GRAVE" }, \
     { DIKS_CAPITAL_W_WITH_GRAVE, "CAPITAL_W_WITH_GRAVE" }, \
     { DIKS_CAPITAL_Y_WITH_GRAVE, "CAPITAL_Y_WITH_GRAVE" }, \
     { DIKS_SMALL_W_WITH_CIRCUMFLEX, "SMALL_W_WITH_CIRCUMFLEX" }, \
     { DIKS_SMALL_Y_WITH_CIRCUMFLEX, "SMALL_Y_WITH_CIRCUMFLEX" }, \
     { DIKS_CAPITAL_W_WITH_CIRCUMFLEX, "CAPITAL_W_WITH_CIRCUMFLEX" }, \
     { DIKS_CAPITAL_Y_WITH_CIRCUMFLEX, "CAPITAL_Y_WITH_CIRCUMFLEX" }, \
     { DIKS_SMALL_W_WITH_DIAERESIS, "SMALL_W_WITH_DIAERESIS" }, \
     { DIKS_CAPITAL_W_WITH_DIAERESIS, "CAPITAL_W_WITH_DIAERESIS" }, \
     { DIKS_CAPITAL_Y_WITH_DIAERESIS, "CAPITAL_Y_WITH_DIAERESIS" }, \
     { DIKS_SMALL_I_TURKEY, "SMALL_I_TURKEY" }, \
     { DIKS_CAPITAL_I_TURKEY, "CAPITAL_I_TURKEY" }, \
     { DIKS_SMALL_C_WITH_ACUTE, "SMALL_C_WITH_ACUTE" }, \
     { DIKS_SMALL_L_WITH_ACUTE, "SMALL_L_WITH_ACUTE" }, \
     { DIKS_SMALL_N_WITH_ACUTE, "SMALL_N_WITH_ACUTE" }, \
     { DIKS_SMALL_R_WITH_ACUTE, "SMALL_R_WITH_ACUTE" }, \
     { DIKS_SMALL_S_WITH_ACUTE, "SMALL_S_WITH_ACUTE" }, \
     { DIKS_SMALL_Z_WITH_ACUTE, "SMALL_Z_WITH_ACUTE" }, \
     { DIKS_CAPITAL_C_WITH_ACUTE, "CAPITAL_C_WITH_ACUTE" }, \
     { DIKS_CAPITAL_L_WITH_ACUTE, "CAPITAL_L_WITH_ACUTE" }, \
     { DIKS_CAPITAL_N_WITH_ACUTE, "CAPITAL_N_WITH_ACUTE" }, \
     { DIKS_CAPITAL_R_WITH_ACUTE, "CAPITAL_R_WITH_ACUTE" }, \
     { DIKS_CAPITAL_S_WITH_ACUTE, "CAPITAL_S_WITH_ACUTE" }, \
     { DIKS_CAPITAL_Z_WITH_ACUTE, "CAPITAL_Z_WITH_ACUTE" }, \
     { DIKS_CARON, "CARON" }, \
     { DIKS_SMALL_C_WITH_CARON, "SMALL_C_WITH_CARON" }, \
     { DIKS_SMALL_D_WITH_CARON, "SMALL_D_WITH_CARON" }, \
     { DIKS_SMALL_E_WITH_CARON, "SMALL_E_WITH_CARON" }, \
     { DIKS_SMALL_L_WITH_CARON, "SMALL_L_WITH_CARON" }, \
     { DIKS_SMALL_N_WITH_CARON, "SMALL_N_WITH_CARON" }, \
     { DIKS_SMALL_R_WITH_CARON, "SMALL_R_WITH_CARON" }, \
     { DIKS_SMALL_S_WITH_CARON, "SMALL_S_WITH_CARON" }, \
     { DIKS_SMALL_T_WITH_CARON, "SMALL_T_WITH_CARON" }, \
     { DIKS_SMALL_Z_WITH_CARON, "SMALL_Z_WITH_CARON" }, \
     { DIKS_CAPITAL_C_WITH_CARON, "CAPITAL_C_WITH_CARON" }, \
     { DIKS_CAPITAL_D_WITH_CARON, "CAPITAL_D_WITH_CARON" }, \
     { DIKS_CAPITAL_E_WITH_CARON, "CAPITAL_E_WITH_CARON" }, \
     { DIKS_CAPITAL_L_WITH_CARON, "CAPITAL_L_WITH_CARON" }, \
     { DIKS_CAPITAL_N_WITH_CARON, "CAPITAL_N_WITH_CARON" }, \
     { DIKS_CAPITAL_R_WITH_CARON, "CAPITAL_R_WITH_CARON" }, \
     { DIKS_CAPITAL_S_WITH_CARON, "CAPITAL_S_WITH_CARON" }, \
     { DIKS_CAPITAL_T_WITH_CARON, "CAPITAL_T_WITH_CARON" }, \
     { DIKS_CAPITAL_Z_WITH_CARON, "CAPITAL_Z_WITH_CARON" }, \
     { DIKS_SMALL_G_WITH_CEDILLA, "SMALL_G_WITH_CEDILLA" }, \
     { DIKS_SMALL_L_WITH_CEDILLA, "SMALL_L_WITH_CEDILLA" }, \
     { DIKS_SMALL_K_WITH_CEDILLA, "SMALL_K_WITH_CEDILLA" }, \
     { DIKS_SMALL_N_WITH_CEDILLA, "SMALL_N_WITH_CEDILLA" }, \
     { DIKS_SMALL_R_WITH_CEDILLA, "SMALL_R_WITH_CEDILLA" }, \
     { DIKS_SMALL_S_WITH_CEDILLA, "SMALL_S_WITH_CEDILLA" }, \
     { DIKS_SMALL_T_WITH_CEDILLA, "SMALL_T_WITH_CEDILLA" }, \
     { DIKS_CAPITAL_G_WITH_CEDILLA, "CAPITAL_G_WITH_CEDILLA" }, \
     { DIKS_CAPITAL_L_WITH_CEDILLA, "CAPITAL_L_WITH_CEDILLA" }, \
     { DIKS_CAPITAL_K_WITH_CEDILLA, "CAPITAL_K_WITH_CEDILLA" }, \
     { DIKS_CAPITAL_N_WITH_CEDILLA, "CAPITAL_N_WITH_CEDILLA" }, \
     { DIKS_CAPITAL_R_WITH_CEDILLA, "CAPITAL_R_WITH_CEDILLA" }, \
     { DIKS_CAPITAL_S_WITH_CEDILLA, "CAPITAL_S_WITH_CEDILLA" }, \
     { DIKS_CAPITAL_T_WITH_CEDILLA, "CAPITAL_T_WITH_CEDILLA" }, \
     { DIKS_BREVE, "BREVE" }, \
     { DIKS_SMALL_A_WITH_BREVE, "SMALL_A_WITH_BREVE" }, \
     { DIKS_SMALL_G_WITH_BREVE, "SMALL_G_WITH_BREVE" }, \
     { DIKS_CAPITAL_A_WITH_BREVE, "CAPITAL_A_WITH_BREVE" }, \
     { DIKS_CAPITAL_G_WITH_BREVE, "CAPITAL_G_WITH_BREVE" }, \
     { DIKS_OGONEK, "OGONEK" }, \
     { DIKS_SMALL_A_WITH_OGONEK, "SMALL_A_WITH_OGONEK" }, \
     { DIKS_SMALL_E_WITH_OGONEK, "SMALL_E_WITH_OGONEK" }, \
     { DIKS_SMALL_I_WITH_OGONEK, "SMALL_I_WITH_OGONEK" }, \
     { DIKS_SMALL_U_WITH_OGONEK, "SMALL_U_WITH_OGONEK" }, \
     { DIKS_CAPITAL_A_WITH_OGONEK, "CAPITAL_A_WITH_OGONEK" }, \
     { DIKS_CAPITAL_E_WITH_OGONEK, "CAPITAL_E_WITH_OGONEK" }, \
     { DIKS_CAPITAL_I_WITH_OGONEK, "CAPITAL_I_WITH_OGONEK" }, \
     { DIKS_CAPITAL_U_WITH_OGONEK, "CAPITAL_U_WITH_OGONEK" }, \
     { DIKS_ABOVEDOT, "ABOVEDOT" }, \
     { DIKS_SMALL_E_WITH_ABOVEDOT, "SMALL_E_WITH_ABOVEDOT" }, \
     { DIKS_SMALL_I_WITH_ABOVEDOT, "SMALL_I_WITH_ABOVEDOT" }, \
     { DIKS_SMALL_Z_WITH_ABOVEDOT, "SMALL_Z_WITH_ABOVEDOT" }, \
     { DIKS_CAPITAL_E_WITH_ABOVEDOT, "CAPITAL_E_WITH_ABOVEDOT" }, \
     { DIKS_CAPITAL_I_WITH_ABOVEDOT, "CAPITAL_I_WITH_ABOVEDOT" }, \
     { DIKS_CAPITAL_Z_WITH_ABOVEDOT, "CAPITAL_Z_WITH_ABOVEDOT" }, \
     { DIKS_DOUBLEACUTE, "DOUBLEACUTE" }, \
     { DIKS_SMALL_U_WITH_DOUBLEACUTE, "SMALL_U_WITH_DOUBLEACUTE" }, \
     { DIKS_SMALL_O_WITH_DOUBLEACUTE, "SMALL_O_WITH_DOUBLEACUTE" }, \
     { DIKS_CAPITAL_U_WITH_DOUBLEACUTE, "CAPITAL_U_WITH_DOUBLEACUTE" }, \
     { DIKS_CAPITAL_O_WITH_DOUBLEACUTE, "CAPITAL_O_WITH_DOUBLEACUTE" }, \
     { DIKS_SMALL_CYRILLIC_K, "SMALL_CYRILLIC_K" }, \
     { DIKS_CAPITAL_CYRILLIC_K, "CAPITAL_CYRILLIC_K" }, \
     { DIKS_SMALL_CYRILLIC_R, "SMALL_CYRILLIC_R" }, \
     { DIKS_CAPITAL_CYRILLIC_R, "CAPITAL_CYRILLIC_R" }, \
     { DIKS_SMALL_CYRILLIC_K_WITH_AP, "SMALL_CYRILLIC_K_WITH_AP" }, \
     { DIKS_CAPITAL_CYRILLIC_K_WITH_AP, "CAPITAL_CYRILLIC_K_WITH_AP" }, \
     { DIKS_SMALL_CYRILLIC_R_WITH_AP, "SMALL_CYRILLIC_R_WITH_AP" }, \
     { DIKS_CAPITAL_CYRILLIC_R_WITH_AP, "CAPITAL_CYRILLIC_R_WITH_AP" }, \
     { DIKS_LEFT_DOUBLE_QUOTATION, "LEFT_DOUBLE_QUOTATION" }, \
     { DIKS_RIGHT_SIGLE_QUOTATION, "RIGHT_SIGLE_QUOTATION" }, \
     { DIKS_DEGREE_SIGN, "DEGREE_SIGN" }, \
     { DIKS_RIGHT_DOUBLE_QUOTATION, "RIGHT_DOUBLE_QUOTATION" }, \
     { DIKS_INVERTED_EXCLAMATION_MARK, "INVERTED_EXCLAMATION_MARK" }, \
     { DIKS_INVERTED_QUESTION_MARK, "INVERTED_QUESTION_MARK" }, \
     ...
     { DIKS_DEAD_DEGREE, "DEAD_DEGREE" }, \
     { DIKS_DEAD_DEGREE_LAT, "DEAD_DEGREE_LAT" }, \
     { DIKS_DEAD_DEGREE_CZE, "DEAD_DEGREE_CZE" }, \
     { DIKS_DEAD_GRC_TONOS, "DEAD_GRC_TONOS" }, \
     { DIKS_DEAD_GRC_DIAERESIS, "DEAD_GRC_DIAERESIS" }, \
     { DIKS_DEAD_GRC_DIALYTIKA, "DEAD_GRC_DIALYTIKA" }, \
     { DIKS_DEAD_ACUTE_CZE, "DEAD_ACUTE_CZE" }, \
     { DIKS_DEAD_CEDILLA_CZE, "DEAD_CEDILLA_CZE" }, \
     { DIKS_DEAD_MIDDLEDOT, "DEAD_MIDDLEDOT" }, \
     { DIKS_DEAD_APOSTROPHE, "DEAD_APOSTROPHE" }, \
...
#define DirectFBKeyIdentifierNames(Identifier) struct DFBKeyIdentifierName Identifier[] = { \
     ...
     { DIKI_KP_8, "KP_8" }, \
     { DIKI_KP_9, "KP_9" }, \
     { DIKI_KEY_UNMAPPING, "KEY_UNMAPPING" }, \

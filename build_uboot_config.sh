...
UBOOT_SUBPATH="bootable/bootloader/uboot-mstar/t22/sboot"

# Expected image files are seperated with ":"
UBOOT_IMAGES="out/unsigned/chunk_header.bin.unsigned:out/unsigned/hash0.bin:out/unsigned/sboot.bin.unsigned:out/unsigned/u-boot.bin"
